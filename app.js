...
const allowedOrigins = [
  ...
  "https://unicare-student-system.vercel.app",
  "https://unicare-admin-panel.vercel.app",
  "http://localhost:5174",
  "http://localhost:5173",
];
const corsOptions = {
...
app.post(
  ...
  (req, res) => {
    res.status(200).json({
      ...
      vidOriginalName: req.file.originalname,
      vidSize: req.file.size,
    });
  }
);
...
app.post(
  ...
  (req, res) => {
    res.status(200).json({
      ...
      audOriginalName: req.file.originalname,
      audSize: req.file.size,
    });
  }
);
